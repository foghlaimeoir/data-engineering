...
import dlt_test
from dlt_test.common import pendulum
from dlt_test.sources.credentials import ConnectionStringCredentials
...
def load_select_tables_from_database() -> None:
    ...
    pipeline = dlt.pipeline(
        pipeline_name="bigquery", destination='duckdb', dataset_name="pypi_analytics"
    )
